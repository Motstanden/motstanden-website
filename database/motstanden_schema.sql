...
/* vw_image_album(image_album_id,title,url,is_public,cover_image_url,image_count,created_by_user_id,created_by_full_name,created_at,updated_by_user_id,updated_by_full_name,updated_at) */;
