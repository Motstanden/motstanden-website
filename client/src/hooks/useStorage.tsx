...
function useStorage<T>(key: string, initialValue: T | (() => T), storage: Storage): StorageType<T> {
 ...
 */
export function useLocalStorage<T>(key: string, initialValue: T | (() => T)): StorageType<T> {
 ...
 */
export function useSessionStorage<T>(key: string, initialValue: T | (() => T)): StorageType<T> {
